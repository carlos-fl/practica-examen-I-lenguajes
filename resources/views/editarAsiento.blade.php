        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input name="id" type="text" class="form-control" value="{{ $tipoAsiento->idTipoAsiento }}" readonly/>
                </div>
                <form action="{{ route('tipos.asientos.editado.guardar', $tipoAsiento->idTipoAsiento) }}" method="post">
                    @csrf
                    @method('put')
                    <div class="form-group">
