    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <br>
                <form action="{{ route('vuelos.crear') }}" method="post">
                    @method('post')
                    @csrf
                    <div class="form-group">
                        <label for="color">Numero:</label>
                        <input name="numeroVuelo" type="text" class="form-control" />
                    </div>
                    <div class="form-group">
                    ...
                    <br>
                    <div class="form-group">
                        <a class="btn btn-warning" href="{{ route('vuelos.inicio') }}">Volver</a>
